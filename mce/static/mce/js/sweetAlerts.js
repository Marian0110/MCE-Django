console.log('SweetAlert script cargado');
...
function datoCos() {
    Swal.fire({
        title: 'Sabias que...',
        text: 'Costa Rica es conocida por su café "shadegrown", que se cultiva bajo la sombra de árboles altos en armonía con el ecosistema circundante',
        icon: 'question',
